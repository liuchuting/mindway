...
class CamembertSdpaSelfAttention(CamembertSelfAttention):
    ...
    def construct(
        ...
        if self.position_embedding_type != "absolute" or output_attentions or head_mask is not None:
            ...
            logger.warning_once(
                "CamembertSdpaSelfAttention is used but `scaled_dot_product_attention` does not support "
...
class CamembertPreTrainedModel(MSPreTrainedModel):
    """
...
class CamembertForCausalLM(CamembertPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs,
        ...
        >>> from mindway import CamembertForCausalLM
        >>> import mindspore as ms
