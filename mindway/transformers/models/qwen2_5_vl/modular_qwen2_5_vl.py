...
from mindway.transformers.models.qwen2_vl.configuration_qwen2_vl import Qwen2VLConfig
...
from mindway.transformers.models.qwen2_vl.processing_qwen2_vl import Qwen2VLProcessor
...
class Qwen2_5_VLForConditionalGeneration(Qwen2VLForConditionalGeneration):
    ...
    def get_rope_index(
        ...
        if input_ids is not None and (image_grid_thw is not None or video_grid_thw is not None):
            ...
            mrope_position_deltas = ms.Tensor(mrope_position_deltas, device=input_ids.device).unsqueeze(1)
            ...
            if attention_mask is not None:
                ...
                position_ids = (
                    mint.arange(input_ids.shape[1], device=input_ids.device)
                    .view(1, 1, -1)
    ...
    def construct(
        ...
        r"""
            labels (`ms.Tensorms.Tensor` of shape `(batch_size, sequence_length)`, *optional*):
        ...
        if position_ids is None and (attention_mask is None or attention_mask.ndim == 2):
            ...
            # then use the prev pre-calculated rope-deltas to get the correct position ids
                ...
                position_ids = mint.arange(seq_length, device=inputs_embeds.device)
