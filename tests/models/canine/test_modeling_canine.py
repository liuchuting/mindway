...
class CanineModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        if self.use_token_type_ids:
            token_type_ids = ids_numpy(input_ids.shape, self.type_vocab_size)
        ...
        return config, input_ids, token_type_ids, input_mask, sequence_labels, token_labels, choice_labels, self.num_choices
...
model_tester = CanineModelTester()
config, input_ids, token_type_ids, input_mask, sequence_labels, token_labels, choice_labels, num_choices = model_tester.prepare_config_and_inputs()
